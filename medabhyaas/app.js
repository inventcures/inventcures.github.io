'use strict';
const scenarios={
  respiratory:{symbol:'क',title:'A worker in western UP',meta:'50-year-old woman · respiratory presentation',language:'Hindi / regional register',lang:'hi',patient:'“खाँसी तो है… और कपड़े भी कुछ ढीले लग रहे हैं।”',translation:'“There’s the cough… and my clothes seem a little looser.”',student:'“अच्छा… वेट, मेरा मतलब वजन, कम हुआ है? कब से ऐसा लग रहा है?”',studentTranslation:'“Okay… weight, I mean your weight, has it gone down? Since when have you noticed this?”',learning:'Notice the indirect clue, characterize it, and use the clarified history when considering the next step. The clue alone does not establish a diagnosis.'},
  glycemic:{symbol:'ख',title:'A farmer from Haryana',meta:'65-year-old man · change in glycemic control',language:'Hindi / Haryanvi register target',lang:'hi',patient:'“दवाई तो लेता हूँ… पर पिछले कुछ दिनों से ढंग से नहीं ली।”',translation:'“I do take my medicine… but I haven’t taken it regularly over the last few days.”',student:'“कौन-सी दवाई लेते हैं? और… रूटीन में क्या बदला, जिससे दवाई लेना मुश्किल हुआ?”',studentTranslation:'“Which medicine do you take? And… what changed in your routine that made taking it difficult?”',learning:'Explore medication use and the patient’s circumstances without blame. Establish the actual pattern and assess severity; occupation or residence does not explain adherence. This Hindi sentence is a placeholder for native-speaker-reviewed regional wording.'},
  concern:{symbol:'ক',title:'A patient with a caregiver',meta:'Constructed difficult-conversation scenario',language:'Bengali / code-mixing target',lang:'bn',patient:'“আমি ঠিক আছি… কিন্তু বাড়ি গিয়ে কী করতে হবে?”',translation:'“I’m okay… but what should I do when I get home?”',student:'“আমরা next steps একসঙ্গে দেখি… বাড়ি ফেরা নিয়ে কোন চিন্তাটা বেশি হচ্ছে?”',studentTranslation:'“Let’s look at the next steps together… what worries you most about going home?”',learning:'Invite the patient’s concerns, explain the plan, and check understanding. The caregiver may have a different concern. Do not assume that “I’m okay” means either distress or reassurance without further context.'}
};
const stages={
...
document.querySelectorAll('[data-scenario]').forEach(button=>button.addEventListener('click',()=>{
  ...
  for(const [id,key] of [['persona-symbol','symbol'],['persona-title','title'],['persona-meta','meta'],['persona-language','language'],['patient-line','patient'],['patient-translation','translation'],['student-line','student'],['student-translation','studentTranslation'],['learning-copy','learning']])document.getElementById(id).textContent=s[key];
  document.getElementById('patient-line').lang=s.lang;
  document.getElementById('student-line').lang=s.lang;
